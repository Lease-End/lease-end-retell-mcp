...
import { registerBatchTestTools } from "./batch-test.js";
import { registerConcurrencyTools } from "./concurrency.js";
import { registerSharedComponentTools } from "./shared-component.js";
...
export const registerAllTools = (server: McpServer, retellClient: Retell) => {
  ...
  registerBatchTestTools(server, retellClient);
  registerConcurrencyTools(server, retellClient);
  registerSharedComponentTools(server, retellClient);
};
